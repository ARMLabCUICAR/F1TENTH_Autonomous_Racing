...
public:
    SubscribeAndPublish() {
        ...
        pub_ = n_.advertise<ackermann_msgs::AckermannDriveStamped>("/vesc/low_level/ackermann_cmd_mux/input/teleop", 10);
	...
	ackermann_drive_result.drive.speed = std::min(VEL_MAX,(0.25+KP*(1/(std::abs(angle)+0.01))));
